** HEADER -----------------------------------------------------
**  DO-FILE METADATA
//  algorithm name			    Sync+VeraCrypt_JCtest.do
...
** DATASETS to encrypted file volume using VeraCrypt + Sync desktop app
local datapath "D:\data_test"
** LOGFILES to unencrypted OneDrive folder
local logpath D:\repo_test

** Close any open log fileand open a new log file
capture log close
cap log using "`logpath'\Cryptomator_JCtest", replace
** HEADER -----------------------------------------------------
